Public Class frm_proveedores2
    ...
    Private Sub frm_proveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        clase.consultar("select prv_nombre, prv_codigo from proveedores", "tbl")
    ...
    Private Sub textBox2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles textBox2.TextChanged
        ...
        clase.consultar("select prv_nombre, prv_codigo from proveedores where prv_nombre like '" & criterio & "%' order by prv_nombre asc", "tbl")
        If clase.dt.Tables("tbl").Rows.Count > 0 Then
            dataGridView1.DataSource = clase.dt.Tables("tbl")
            dataGridView1.Columns(0).Width = 300
        Else
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If IsNumeric(dataGridView1.CurrentCell.ColumnIndex) And IsNumeric(dataGridView1.CurrentCell.RowIndex) Then
            'frm_crear_articulo.TextBox9.Text = dataGridView1.Item(1, dataGridView1.CurrentCell.RowIndex).Value
            Me.Close()
        End If
    End Sub
