Public Class frmTransferenciaDevoluciones
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        clase.actualizar("UPDATE cabtransferencia SET tr_destino = " & ComboBox9.SelectedValue & ", tr_revisada = FALSE, tr_operador = '" & UCase(TextBox18.Text) & "' WHERE tr_numero = " & TextBox1.Text & "")
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If clase.dt.Tables("tabla11").Rows.Count > 0 Then
            ...
            With clase.dt.Tables("tabla11")
                ...
                Else
                    clase.agregar_registro("INSERT INTO `dettransferencia`(`dt_trnumero`,`dt_gondola`,`dt_codarticulo`,`dt_cantidad`,`dt_danado`,`dt_costo`,`dt_venta1`,`dt_venta2`) VALUES ('" & TextBox1.Text & "',NULL,'" & codigo_articulo & "','1','0','" & Str(.Rows(0)("ar_costo")) & "','" & Str(.Rows(0)("ar_precio1")) & "','" & Str(.Rows(0)("ar_precio2")) & "')")
                End If
            End With
    ...
    Sub llenar_grilla(transferencias As Integer)
        ...
        End If
        clase.consultar("SELECT articulos." & campo_codigobarra_corto(destinotrans) & ", articulos.ar_referencia, articulos.ar_descripcion, colores.colornombre, tallas.nombretalla, dettransferencia.dt_cantidad, dettransferencia.dt_danado, FORMAT(dt_costo * dt_cantidad, 'Currency'), FORMAT(dt_venta1 * dt_cantidad, 'Currency'), FORMAT(dt_venta2 * dt_cantidad, 'Currency') FROM dettransferencia INNER JOIN articulos ON (dettransferencia.dt_codarticulo = articulos.ar_codigo) INNER JOIN colores ON (colores.cod_color = articulos.ar_color) INNER JOIN tallas ON (tallas.codigo_talla = articulos.ar_talla) WHERE (dettransferencia.dt_trnumero =" & transferencias & ")", "tabla")
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If IsNumeric(DataGridView1.CurrentRow.Index) Then
            ...
            If v = 6 Then
                ...
                clase.actualizar("UPDATE cabtransferencia SET tr_estado = TRUE, tr_destino = " & ComboBox9.SelectedValue & ",tr_operador = '" & UCase(TextBox18.Text) & "' WHERE tr_numero = " & TextBox1.Text & "")

                If MessageBox.Show("¿Desea enviar el archivo de transferencia por e-mail al destino?", "ENVIAR ARCHIVO DE TRANSFERENCIA", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = Windows.Forms.DialogResult.Yes Then
    ...
    Sub guardar_encabezado_transferencia()
        Dim fecha As Date = Now
        clase.agregar_registro("INSERT INTO `cabtransferencia`(`tr_numero`,`tr_destino`,`tr_origen`,`tr_bodega`,`tr_fecha`,`tr_estado`) VALUES ( '" & TextBox1.Text & "',NULL,NULL,NULL,'" & fecha.ToString("yyyy-MM-dd") & "',FALSE)")
    End Sub
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        frm_eliminar_devolucion.ShowDialog()
        frm_eliminar_devolucion.Dispose()
    End Sub

    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        frm_suspendidas_devoluciones.ShowDialog()
        frm_suspendidas_devoluciones.Dispose()
    End Sub
End Class