Public Class frm_listado_importacion8
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If DataGridView1.RowCount = 0 Then
            Exit Sub
        End If
        frmIngresoNoImportados.ConsImport = DataGridView1(1, DataGridView1.CurrentCell.RowIndex).Value.ToString
        frmIngresoNoImportados.txtImportacion.Text = DataGridView1(0, DataGridView1.CurrentCell.RowIndex).Value.ToString
        Me.Close()
    End Sub
End Class