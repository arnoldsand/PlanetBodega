Public Class frm_seleccionar_importacion
    Dim clase As New class_library
    Private Sub button5_Click(sender As Object, e As EventArgs) Handles button5.Click
        Me.Close()
    End Sub

    Private Sub frm_seleccionar_importacion_Load(sender As Object, e As EventArgs) Handles Me.Load
        llenar_combo()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If IsNumeric(DataGridView1.CurrentCell.RowIndex) Then
            ...
            frm_articulos_procesados_liquidacion.TextBox9.Text = DataGridView1.Item(0, DataGridView1.CurrentRow.Index).Value
            frm_articulos_procesados_liquidacion.TextBox1.Enabled = True
            Me.Close()
        End If
    End Sub
End Class