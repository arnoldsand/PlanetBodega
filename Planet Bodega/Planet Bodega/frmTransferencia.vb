Public Class frmTransferencia
    ...
    Private Sub frmTransferencia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        clase.agregar_registro("INSERT INTO `cabtransferencia`(`tr_numero`,`tr_destino`,`tr_origen`,`tr_bodega`,`tr_fecha`,`tr_estado`,`tr_operador`,`tr_finalizada`) VALUES ( '" & TextBox1.Text & "',NULL,NULL,NULL,'" & fecha.ToString("yyyy-MM-dd") & "',FALSE,NULL,FALSE)")
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        'esta linea la tengo que habilitar y deshabilitar la de abajo 
        clase.actualizar("UPDATE cabtransferencia SET tr_destino = " & ComboBox9.SelectedValue & ", tr_operador = '" & UCase(TextBox18.Text) & "', tr_revisada = FALSE, tr_opproduccion = '1' WHERE tr_numero = " & TextBox1.Text & "")
        ...
        If clase.dt.Tables("tabla11").Rows.Count > 0 Then
            ...
            With clase.dt.Tables("tabla11")
                ...
                If clase.dt1.Tables("result").Rows.Count > 0 Then
                    ...
                    clase.actualizar("UPDATE dettransferencia SET dt_cantidad = " & cant + cant_captura & " WHERE dt_trnumero = " & TextBox1.Text & " AND dt_codarticulo = " & codigo_articulo & "")
                Else
                    clase.agregar_registro("INSERT INTO `dettransferencia`(`dt_trnumero`,`dt_gondola`,`dt_codarticulo`,`dt_cantidad`,`dt_danado`,`dt_costo`,`dt_venta1`,`dt_venta2`,`dt_costo2`) VALUES ('" & TextBox1.Text & "',NULL,'" & codigo_articulo & "','" & cant_captura & "','0','" & Str(RecuperarCostoReal(codigo_articulo)) & "','" & Str(.Rows(0)("ar_precio1")) & "','" & Str(.Rows(0)("ar_precio2")) & "','" & Str(RecuperarCostoFiscal(codigo_articulo)) & "')")
                End If
                cant_captura = 1
            End With
    ...
    Sub preparar_columnas()
        With DataGridView1
            ...
            .Columns(6).HeaderText = "Precio Venta1"
            .Columns(0).Width = 80
            .Columns(1).Width = 90
            .Columns(2).Width = 170
            .Columns(3).Width = 80
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        If IsNumeric(DataGridView1.CurrentRow.Index) Then
            frm_eliminar6.ShowDialog()
            frm_eliminar6.Dispose()
        End If
    End Sub
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        frm_suspendidas1.ShowDialog()
        frm_suspendidas1.Dispose()
    ...
    'Function CalcularCodigoTransferencia(IdTiendaDestino As Integer) As String
    '    clase.consultar("Select MigradoLovePos From tiendas Where id = " & IdTiendaDestino & "", "migrado")
    '    If clase.dt.Tables("migrado").Rows(0)("MigradoLovePos") = True Then
    '        Dim CodigoTransferencia As String = ""
    '        clase.ConsultarSQLServer("SELECT [Consecutivo] FROM [dbo].[ConsecutivosDocInventarioTienda] WHERE IdTienda = 99 AND IdDocumentoInventario = 'TRS' AND IdTiendaDestino = " & IdTiendaDestino & "", "trans")
    '        If clase.dtSql.Tables("trans").Rows.Count > 0 Then
    '            CodigoTransferencia = "TRS-099" & IdTiendaDestino.ToString("000") + (clase.dtSql.Tables("trans").Rows(0)("Consecutivo") + 1).ToString("0000")
    '        Else
    '            CodigoTransferencia = "TRS-099" & IdTiendaDestino.ToString("000") + "0001"
    '        End If
    '        Return ", tr_codigolovepos = " & "'" & CodigoTransferencia & "'"
    '    Else
    '        Return ""
    '    End If
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If IsNumeric(DataGridView1.CurrentRow.Index) Then
            ...
            If v = 6 Then
                ...
                '    clase.actualizar("UPDATE cabtransferencia SET  tr_revisada = TRUE WHERE tr_numero = " & TextBox1.Text & "") 'quitar esta linea
                'imprimir_hoja_transferencia(TextBox1.Text)
    ...
    Sub guardar_encabezado_transferencia()
        Dim fecha As Date = Now
        clase.agregar_registro("INSERT INTO `cabtransferencia`(`tr_numero`,`tr_destino`,`tr_origen`,`tr_bodega`,`tr_fecha`,`tr_estado`,`tr_operador`) VALUES ( '" & TextBox1.Text & "',NULL,NULL,NULL,'" & fecha.ToString("yyyy-MM-dd") & "',FALSE,NULL)")
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs)
        frm_danado_transferencia.ShowDialog()
        frm_danado_transferencia.Dispose()
    End Sub
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        Dim formularioEdicionCantidad As frm_captura_multiple = New frm_captura_multiple(cant_captura)
        formularioEdicionCantidad.ShowDialog()
        formularioEdicionCantidad.Dispose()
        TextBox5.Focus()
    End Sub

    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        If DataGridView1.Rows.Count = 0 Then Exit Sub ' HACER ESTO EN TODAS LAS LINEAS DE CODIGO
