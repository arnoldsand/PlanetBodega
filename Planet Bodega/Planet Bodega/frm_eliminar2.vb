Public Class frm_eliminar2
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If clase.dt.Tables("tabla11").Rows.Count > 0 Then
            clase.consultar1("select detent_codigo, detent_cantidad from detalle_entrada WHERE (detent_cod_entrada =" & frm_almacenaje_articulos.textBox2.Text & " AND detent_gondola ='" & UCase(frm_ver_gondola_almacenar.textBox2.Text) & "' AND detent_articulo = " & codigo_articulo & ")", "123")
            If clase.dt1.Tables("123").Rows.Count > 0 Then
                ...
                If v = 6 Then
                    ...
                    If totcant > 1 Then
                        clase.actualizar("UPDATE detalle_entrada SET detent_cantidad = " & totcant - 1 & " WHERE (detent_cod_entrada =" & frm_almacenaje_articulos.textBox2.Text & " AND detent_gondola ='" & UCase(frm_ver_gondola_almacenar.textBox2.Text) & "' AND detent_articulo = " & codigo_articulo & ")")
                    Else
                        clase.borradoautomatico("Delete from detalle_entrada WHERE (detent_cod_entrada =" & frm_almacenaje_articulos.textBox2.Text & " AND detent_gondola ='" & UCase(frm_ver_gondola_almacenar.textBox2.Text) & "' AND detent_articulo = " & codigo_articulo & ")")
                    End If
                    frm_ver_gondola_almacenar.llenar_grilla(frm_almacenaje_articulos.textBox2.Text, UCase(frm_ver_gondola_almacenar.textBox2.Text))
                    TextBox4.Text = ""
                    TextBox4.Focus()
                End If
            Else
    ...
    Private Sub frm_eliminar2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox4.Focus()
    End Sub
End Class