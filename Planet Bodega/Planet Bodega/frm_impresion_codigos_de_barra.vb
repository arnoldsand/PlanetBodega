...
Public Class frm_impresion_codigos_de_barra
        ...
        If ind = False Then
            ...
            For z = 0 To dataGridView1.RowCount - 1
                If dataGridView1.Item(0, z).Value = True Then
                    ean13.imprimir_codigos_de_barra_33_x_25(dataGridView1.Item(1, z).Value, dataGridView1.Item(8, z).Value, ComboBox6.Text)
