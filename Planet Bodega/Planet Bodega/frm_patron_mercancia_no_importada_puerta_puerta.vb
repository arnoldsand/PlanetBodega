Public Class frm_patron_mercancia_no_importada_puerta_puerta
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        frm_ingreso_puerta_puerta_puerta_puerta.Patron = DataGridView1(0, [Y]).Value.ToString
        frm_ingreso_puerta_puerta_puerta_puerta.NombrePatron = DataGridView1(1, [Y]).Value.ToString
    End Sub
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        If frm_ingreso_puerta_puerta_puerta_puerta.Patron = "" Then
            MessageBox.Show("DEBE SELECCIONAR UN PATRO DE DISTRIBUCION", "PLANET LOVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        frm_ingreso_puerta_puerta_puerta_puerta.indicador_presionador_de_boton = True
        Me.Close()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        asignar_cant_patron_dist_puerta_puerta.ShowDialog()
        asignar_cant_patron_dist_puerta_puerta.Dispose()
    End Sub
