Public Class frm_busqueda_articulos_puerta_puerta
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        If codigo = "" Then
            Me.Close()
        Else
            frm_ingreso_puerta_puerta_puerta_puerta.txtArticulo.Text = grdConsulta(0, grdConsulta.CurrentCell.RowIndex).Value.ToString
            Me.Close()
        End If
    ...
    Private Sub Precios_Click(sender As Object, e As EventArgs) Handles Precios.Click
        If grdConsulta.RowCount = 0 Then
            Exit Sub
        End If
        frm_cambio_precios_puerta_puerta.txtCodigo.Text = grdConsulta(0, grdConsulta.CurrentCell.RowIndex).Value.ToString
        frm_cambio_precios_puerta_puerta.txtReferencia.Text = grdConsulta(1, grdConsulta.CurrentCell.RowIndex).Value.ToString
        frm_cambio_precios_puerta_puerta.txtDescripcion.Text = grdConsulta(2, grdConsulta.CurrentCell.RowIndex).Value.ToString
        frm_cambio_precios_puerta_puerta.txtCosto.Text = extraer_costo2(grdConsulta(0, grdConsulta.CurrentCell.RowIndex).Value)
        frm_cambio_precios_puerta_puerta.txtCosto2.Text = grdConsulta(5, grdConsulta.CurrentCell.RowIndex).Value.ToString
        frm_cambio_precios_puerta_puerta.txtPrecio1.Text = grdConsulta(6, grdConsulta.CurrentCell.RowIndex).Value.ToString
        frm_cambio_precios_puerta_puerta.txtPrecio2.Text = grdConsulta(7, grdConsulta.CurrentCell.RowIndex).Value.ToString
        frm_cambio_precios_puerta_puerta.ShowDialog()
        frm_cambio_precios_puerta_puerta.Dispose()
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        indicador_de_formulario2 = True
        frm_crear_articulo.ShowDialog()
        frm_crear_articulo.Dispose()
        indicador_de_formulario2 = False
    End Sub
End Class