Public Class frm_cambio_precios
    ...
    Private Sub frm_cambio_precios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        filaactual = frm_busqueda_articulos.grdConsulta.CurrentCell.RowIndex
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If MessageBox.Show("DESEA MODIFICAR LOS DATOS DEL PRODUCTO?", "PLANET LOVE", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            frm_busqueda_articulos.llenar_rejilla()
            frm_busqueda_articulos.grdConsulta.CurrentCell = frm_busqueda_articulos.grdConsulta.Item(0, filaactual)
            Me.Close()
        Else
            txtCosto.Text = costo
