Public Class frm_generar_ajuste_para_gondola2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If clase.validar_cajas_text(TextBox5, "Ajuste") = False Then Exit Sub
        If verificar_existencia_gondola(UCase(textBox2.Text.Trim), bodegaalmacenaje) = False Then
            MessageBox.Show("La góndola especificada no existe.", "GÓNDOLA NO EXISTE", MessageBoxButtons.OK, MessageBoxIcon.Error)
            textBox2.Text = ""
            textBox2.Focus()
            Exit Sub
        End If
        clase.consultar("SELECT* FROM detajuste WHERE (detaj_gondola ='" & UCase(textBox2.Text) & "' AND detaj_codigo_ajuste =" & TextBox5.Text & ")", "tbl123")
    ...
    Private Sub frm_generar_ajuste_para_gondola2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If clase.dt.Tables("tabla11").Rows.Count > 0 Then
            ...
            With DataGridView1
                ...
                .Item(5, .RowCount - 1).Value = cant_articulos_x_gondola(UCase(textBox2.Text), bodegaalmacenaje, codigo_articulo)
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        If v = 6 Then
            clase.borradoautomatico("delete from detajuste where detaj_codigo_ajuste = " & TextBox5.Text & " AND detaj_gondola = '" & UCase(textBox2.Text) & "'")
            Dim i As Short
            For i = 0 To DataGridView1.RowCount - 1
                With DataGridView1
                    clase.agregar_registro("INSERT INTO `detajuste`(`detaj_codigo_ajuste`,`detaj_gondola`,`detaj_articulo`,`detaj_cantidad`,`detaj_cantidad_anterior`,`detaj_precio_costo`,`detaj_precio_venta1`,`detaj_precio_venta2`) VALUES ('" & TextBox5.Text & "','" & UCase(textBox2.Text) & "','" & .Item(0, i).Value & "','" & .Item(6, i).Value & "','" & .Item(5, i).Value & "','" & Str(RecuperarCostoReal(.Item(0, i).Value)) & "','" & Str(precio_venta1(.Item(0, i).Value)) & "','" & Str(precio_venta2(.Item(0, i).Value)) & "')")
                End With
            Next
            restablecer()
        End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If DataGridView1.RowCount = 0 Then
            Exit Sub
        End If
        frm_eliminar4.ShowDialog()
        frm_eliminar4.Dispose()
    End Sub
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        frm_lista_ajustes.ShowDialog()
        frm_lista_ajustes.Dispose()
    End Sub
End Class