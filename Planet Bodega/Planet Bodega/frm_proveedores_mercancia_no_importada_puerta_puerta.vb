Public Class frm_proveedores_mercancia_no_importada_puerta_puerta
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If IsNumeric(dataGridView1.CurrentCell.ColumnIndex) And IsNumeric(dataGridView1.CurrentCell.RowIndex) Then
            frm_ingreso_puerta_puerta_puerta_puerta.IdProveedor = dataGridView1.Item(1, dataGridView1.CurrentCell.RowIndex).Value
            frm_ingreso_puerta_puerta_puerta_puerta.CodProveedor = dataGridView1.Item(0, dataGridView1.CurrentCell.RowIndex).Value
            Me.Close()
        End If
    End Sub
